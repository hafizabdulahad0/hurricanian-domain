      ...
      <div className="max-w-3xl mx-auto">
        <div className="p-8 rounded-lg shadow-sm border border-gray-100 mb-12 bg-inherit">
          ...
          <div className="mt-6 text-sm text-gray-600">
            <p>Before starting the transfer process, please ensure:</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <Card className="p-6 hover-lift">
            <div className="flex items-start">
              <div className="bg-primary text-primary-foreground p-3 rounded-full hover-glow">
          ...
          <Card className="p-6 hover-lift">
            <div className="flex items-start">
              <div className="bg-secondary text-secondary-foreground p-3 rounded-full hover-glow">
        ...
        <div className="p-8 rounded-lg bg-inherit">
          ...
          <Button className="bg-primary hover:bg-primary/90 button-hover">
