          ...
          {hostingPlans.map((plan, index) => (
            ...
            >
              ...
              <div className="mb-4 flex items-center">
                <div className={`${plan.popular ? 'bg-primary' : 'bg-primary/10'} p-3 rounded-full mr-4 hover-glow`}>
      ...
      <div className="mt-16 mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="p-6 border border-gray-100 hover:shadow-md transition-shadow hover-lift">
            <div className="bg-primary/10 text-primary p-3 rounded-full inline-flex items-center justify-center w-12 h-12 mb-4 hover-glow">
          ...
          <Card className="p-6 border border-gray-100 hover:shadow-md transition-shadow hover-lift">
            <div className="bg-secondary/10 text-secondary p-3 rounded-full inline-flex items-center justify-center w-12 h-12 mb-4 hover-glow">
          ...
          <Card className="p-6 border border-gray-100 hover:shadow-md transition-shadow hover-lift">
            <div className="bg-accent/10 text-accent p-3 rounded-full inline-flex items-center justify-center w-12 h-12 mb-4 hover-glow">
